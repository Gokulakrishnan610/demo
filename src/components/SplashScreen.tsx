        ...
        >
          ...
          <div className="absolute inset-0 pointer-events-none">
            <motion.div
              ...
              style={{
                background:
                  'radial-gradient(1200px 600px at 50% 50%, rgba(244,160,25,0.08), transparent 60%)',
              }}
            />
          </div>
          ...
          <motion.img
            ...
            loading="eager"
            className="h-16 md:h-20 w-auto select-none drop-shadow-[0_6px_24px_rgba(0,0,0,0.12)]"
            draggable={false}
          ...
          <motion.span
            ...
            style={{ width: 200, height: 200, borderRadius: '9999px', border: '1px solid rgba(244,160,25,0.25)' }}
